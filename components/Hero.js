      ...
      <div className="container mx-auto px-6 py-32 text-center z-10">
        <div className="animate-fadeInUp">
          ...
          <button
            ...
            className="inline-flex items-center px-8 py-3 md:pyt-4 bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-semibold rounded-full hover:from-purple-600 hover:to-cyan-600 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-slideInUp delay-800"
          >
            View My Work
